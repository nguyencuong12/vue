...
import { MoveableManagerState, Able, MoveableClientRect, MoveableProps, ControlPose, InvertTypes, ArrayFormat, MoveableRefType } from "./types";
...
export declare function fillParams<T extends IObject<any>>(moveable: any, e: any, params: Pick<T, Exclude<keyof T, "moveable" | "target" | "clientX" | "clientY" | "inputEvent" | "datas" | "currentTarget">>): T;
export declare function fillEndParams<T extends IObject<any>>(moveable: any, e: any, params: Pick<T, Exclude<keyof T, "moveable" | "target" | "clientX" | "clientY" | "inputEvent" | "datas" | "currentTarget" | "lastEvent" | "isDrag" | "isDouble">> & {
    isDrag?: boolean;
}): T;
...
export declare function directionCondition(e: any): any;
export declare function invertObject<T extends IObject<any>>(obj: T): InvertTypes<T>;
...
export declare function getRefTarget<T extends HTMLElement | SVGElement = HTMLElement | SVGElement>(target: MoveableRefType<T>, isSelector?: false): T | string | null;
export declare function getRefTargets(targets: MoveableRefType | MoveableRefType[]): (string | SVGElement | HTMLElement | null | undefined)[];
