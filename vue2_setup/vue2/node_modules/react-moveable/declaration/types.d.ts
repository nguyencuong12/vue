...
export interface RotatableOptions {
    rotatable?: boolean;
    rotationPosition?: "top" | "bottom" | "left" | "right" | "top-right" | "top-left" | "bottom-right" | "bottom-left" | "left-top" | "left-bottom" | "right-top" | "right-bottom";
...
export declare type Entries<T> = {
    [key in keyof T]: {
        key: key;
        value: Readonly<T[key]>;
    };
};
export declare type InferKey<E, V> = E extends {
    key: infer U;
    value: V;
} ? U & string : never;
export declare type InvertTypes<T extends IObject<any>, En extends IObject<any> = Entries<T>> = {
