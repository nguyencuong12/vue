export declare const MOVEABLE_ABLES: readonly [{
    ...
    drag(moveable: import("../types").MoveableManagerInterface<import("../types").SnappableProps, import("../types").SnappableState>, e: any): void;
    ...
    dragControlCondition(e: any): boolean | undefined;
    ...
    readonly events: {};
    readonly dragControlCondition: (e: any, moveable: import("../types").MoveableManagerInterface<import("../types").DraggableProps, {}>) => boolean;
    readonly dragControlStart: (moveable: import("../types").MoveableManagerInterface<import("../types").DraggableProps, {}>, e: any) => false | import("../types").OnDragStart;
    readonly dragControl: (moveable: import("../types").MoveableManagerInterface<import("../types").DraggableProps, {}>, e: any) => import("../types").OnDrag | undefined;
    readonly dragControlEnd: (moveable: import("../types").MoveableManagerInterface<import("../types").DraggableProps, any>, e: any) => any;
    readonly dragGroupControlCondition: (e: any, moveable: import("../types").MoveableGroupInterface<import("../types").DraggableProps, {}>) => boolean;
    readonly dragGroupControlStart: (moveable: import("../types").MoveableGroupInterface<import("../types").DraggableProps, {}>, e: any) => false | import("../types").OnDragStart;
    readonly dragGroupControl: (moveable: import("../types").MoveableGroupInterface<import("../types").DraggableProps, {}>, e: any) => import("../types").OnDragGroup | undefined;
    readonly dragGroupControlEnd: (moveable: import("../types").MoveableGroupInterface<import("../types").DraggableProps, any>, e: any) => any;
    ...
    readonly dragGroupStart: (moveable: import("../types").MoveableManagerInterface<import("../types").ClickableProps, {}>, e: any) => void;
    readonly dragEnd: (moveable: import("../types").MoveableManagerInterface<import("../types").ClickableProps, {}>, e: any) => void;
    readonly dragGroupEnd: (moveable: import("../types").MoveableGroupInterface<import("../types").ClickableProps, {}>, e: any) => void;
}, {
    name: string;
    props: {
